...
#CONTOH 8938373772
url = "https://id.jagreward.com/member/verify-mobile/82328446505/"
...
def balik():
    ...
    if d == "y":
       subprocess.call("python kintil.py",shell=True)
         ...
         os.system("exit")
bersih()
subprocess.call("figlet Dx-call |lolcat",shell=True)
banner = """
\033[1;97m
==================================================
Author  \033[1;91m:\033[1;96mAdelwinNL\033[1;97m
Youtube \033[1;91m:\033[1;96mAdelwin NL\033[1;97m
Blog  \033[1;91m:\033[1;92mhttp://adelwindx.blogspot.com\033[1;97m
==================================================
"""
print (banner)
